...
public final class WekaUtil {
	...
	private static String[] m5pOptions = {"-U","-R"};
	private static String[] svmOptions = {"-S","4","-K","1","C","0.2"};
	private static String[] nnOptions = {"-L","0.10","-M","0.15","-N","50"};
